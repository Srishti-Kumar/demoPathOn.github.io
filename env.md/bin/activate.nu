...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/srishtikumar/Desktop/proj/Djangopyappfinal/django_google_api_webapp/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/srishtikumar/Desktop/proj/Djangopyappfinal/django_google_api_webapp/env/bin/deactivate.nu'
